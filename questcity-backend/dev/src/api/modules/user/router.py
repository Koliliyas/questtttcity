...
from api.modules.user import responses as user_res
from api.modules.user.schemas import (ChangePasswordSchema, EmailChangeSchema,
...
from core.authentication.services import ChangeEmailVerificationService
from core.dto import EmailMessageDTO
from core.services import EmailSenderService
from core.user import exceptions as user_exc
from core.user.dto import (ProfileCreateDTO, UserCreateAdminDTO,
