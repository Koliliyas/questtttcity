...
from src.core.authentication.exceptions import UserNotFoundForEmailError
from src.core.profile.repositories import ProfileRepository
from src.core.user.dto import (ProfileCreateDTO, UserCreateAdminDTO, UserCreateDTO,
