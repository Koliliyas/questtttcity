#!/usr/bin/env python3
"""
Исправленный скрипт для тестирования входа в QuestCity через API
"""
...
def test_login(login, password, base_url="http://questcity.ru/api/v1/"):
    ...
    # Данные для входа (правильные поля)
    login_data = {
        "login": login,
        "password": password
    }
...
def main():
    ...
    for account in test_accounts:
        ...
        token = test_login(account["login"], account["password"])
