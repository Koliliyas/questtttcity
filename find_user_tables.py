#!/usr/bin/env python3
"""
Поиск таблиц, связанных с пользователями
"""
import psycopg2
...
def find_user_tables():
    ...
    try:
        ...
        # Ищем все таблицы в схеме public, которые могут содержать данные пользователей
        ...
        for table in public_tables:
            ...
            if user_columns:
                print(f"    🔑 Поля, связанные с пользователями:")
