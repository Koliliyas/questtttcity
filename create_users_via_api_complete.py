#!/usr/bin/env python3
"""
Полный скрипт для создания пользователей QuestCity через API регистрации
"""
...
def create_user_via_api(email, password, username, first_name, last_name, role="user"):
    ...
    # Данные для регистрации с правильными полями
    registration_data = {
        "email": email,
        "username": username,
...
def main():
    ...
    # Создаем администратора (пароль с заглавной буквой и специальным символом)
    print("\n👑 Создание администратора...")
    admin_created = create_user_via_api(
        email="admin@questcity.com",
        password="Admin123!",  # Заглавная буква + специальный символ
        username="admin",
        first_name="Admin",
        last_name="User",
        role="admin"
    ...
    # Создаем тестового пользователя (пароль с заглавной буквой и специальным символом)
    print("\n👤 Создание тестового пользователя...")
    user_created = create_user_via_api(
        email="testuser@questcity.com",
        password="Password123!",  # Заглавная буква + специальный символ
        username="testuser",
        first_name="Test",
        last_name="User",
        role="user"
