...
class GetMiles extends UseCase<List<QuestParameterEntity>, NoParams> {
  final QuestRepository questRepository;

  GetMiles(this.questRepository);

  @override
  Future<Either<Failure, List<QuestParameterEntity>>> call(
      NoParams params) async {
    print('🔍 DEBUG: GetMiles.call() - Начинаем загрузку миль');
    try {
      final result = await questRepository.getMiles();
      print(
          '✅ DEBUG: GetMiles.call() - Мили успешно загружены: ${result.length}');
      return result;
    } catch (e) {
      print('❌ ERROR: GetMiles.call() - Ошибка загрузки миль: $e');
