...
class QuestCreateScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => QuestCreateScreenCubit(
        createQuestUC: sl<CreateQuestAdmin>(),
        uploadFileUC: sl(),
        onQuestCreated: onQuestCreated,
      ),
      child: BlocBuilder<QuestCreateScreenCubit, QuestCreateScreenState>(
        builder: (context, state) {
          QuestCreateScreenCubit cubit = context.read<QuestCreateScreenCubit>();

          if (state is QuestCreateScreenInitial) {
            return _buildScreen(context, cubit, state);
          } else if (state is QuestCreateScreenLoading) {
            return _buildLoadingScreen(context);
          } else if (state is QuestCreateScreenSuccess) {
            return _buildSuccessScreen(context, cubit, state);
          } else if (state is QuestCreateScreenError) {
            return _buildErrorScreen(context, cubit, state);
          }

          return _buildScreen(
              context, cubit, state as QuestCreateScreenInitial);
        },
      ),
    );
  }
  ...
  Widget _buildScreen(
    ...
    QuestCreateScreenCubit cubit,
    QuestCreateScreenInitial state,
  ) {
    return Scaffold(
      body: Container(
            ...
            child: Column(
              children: [
                CustomAppBar(
                  ...
                  title: LocaleKeys.kTextCreateQuest.tr(),
                  action: GestureDetector(
                    onTap: () => cubit.createQuest(context),
                    ...
                    children: [
                      ...
                      QuestEditDropdownItem(
                        ...
                        body: CreditsPreferencesBody(
                          radioIndex: state.creditsMode, // 0 = Manual, 1 = Auto
  ...
  List<List<int>> _getSelectedPrefIndexes(QuestCreateScreenInitial state) {
    return [
      [
  ...
  Widget _buildSuccessScreen(
    BuildContext context,
    QuestCreateScreenCubit cubit,
    QuestCreateScreenSuccess state,
  ) {
    return Scaffold(
      body: Container(
        decoration: const BoxDecoration(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16.h),
              Text(
                LocaleKeys.kTextQuestCreatedSuccessfully.tr(),
                style: UiConstants.textStyle16.copyWith(
                  color: UiConstants.whiteColor,
                ),
              ),
              ...
              CustomButton(
                ...
                title: LocaleKeys.kTextReturnToList.tr(),
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16.h),
              Text(
                LocaleKeys.kTextQuestCreationError.tr(),
                style: UiConstants.textStyle16.copyWith(
                  color: UiConstants.whiteColor,
                ),
              ),
