...
class PriceSettingsUpdate extends Equatable {
  final bool isSubscription;
  final double amount;

  const PriceSettingsUpdate({
    this.isSubscription = false,
    this.amount = 0.0,
  });

  factory PriceSettingsUpdate.fromJson(Map<String, dynamic> json) =>
      PriceSettingsUpdate(
  ...
  @override
  List<Object?> get props => [isSubscription, amount];
}
...
class MainPreferencesUpdate extends Equatable {
  ...
  final PriceSettingsUpdate priceSettings;
  ...
  const MainPreferencesUpdate({
    ...
    this.level = 'Easy',
    this.mileage = '5-10',
    this.priceSettings = const PriceSettingsUpdate(),
    this.types = const [],
    this.places = const [],
    this.vehicles = const [],
    this.tools = const [],
  ...
  factory MainPreferencesUpdate.fromJson(Map<String, dynamic> json) =>
      MainPreferencesUpdate(
        ...
        priceSettings:
            PriceSettingsUpdate.fromJson(json['price_settings'] ?? {}),
  ...
  Map<String, dynamic> toJson() {
    final result = {
      ...
      'price_settings': priceSettings.toJson(), // Добавляем price_settings
      'types': types,
      'places': places,
      'vehicles': vehicles,
      'tools': tools,
