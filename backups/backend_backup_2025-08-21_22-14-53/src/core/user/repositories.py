...
from src.core.authentication import utils as auth_utils
from src.core.search import FuzzySearchService
from src.core.user.dto import UserCreateAdminDTO, UserCreateDTO
...
class UserRepository:
    ...
    async def create(self, dto: UserCreateDTO | UserCreateAdminDTO) -> User:
        dto.password = auth_utils.hash_password(dto.password).decode('utf-8')
