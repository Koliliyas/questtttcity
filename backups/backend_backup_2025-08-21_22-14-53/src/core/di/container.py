...
from src.core.di.modules import (authentication, chat, default, favorite, friend,
                             friend_request, merch, quest, unlock_request,
                             user)
from src.settings import (ApplicationSettings, AuthJWTSettings, DatabaseSettings,
