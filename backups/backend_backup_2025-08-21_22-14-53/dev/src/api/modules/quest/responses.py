from api import exceptions as api_ex
from api.modules.merch.exceptions import MerchNotFoundHTTPError
from api.modules.quest import exceptions as module_ex
