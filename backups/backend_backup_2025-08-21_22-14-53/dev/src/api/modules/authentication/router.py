...
from api.exceptions import (EmailAlreadyExistsHTTPError,
...
from api.modules.authentication.responses import (
...
from api.modules.authentication.schemas import (EmailResetPasswordSchema,
                                                RefreshTokenDestroy,
                                                ResetPasswordSchema,
                                                ...
                                                TokensRefreshSchema,
                                                VerifyEmailSchema)
from api.modules.user.schemas import UserCreateSchema
from core.authentication.exceptions import (EmailCodeExpiredError,
                                            InactiveUserError,
...
from core.user.dto import ProfileCreateDTO, UserCreateDTO
...
async def register(
    ...
    email_verification_service: Injected[RegistrationEmailVerificationService],
...
async def verify_register(
    ...
    result = await email_verification_service.verify_code(
