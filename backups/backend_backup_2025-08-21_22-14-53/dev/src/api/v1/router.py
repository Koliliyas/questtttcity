...
from api.modules.authentication.router import router as auth_router
from api.modules.chat.router import router as chat_router
from api.modules.favorite.router import router as favorite_router
from api.modules.friend.router import router as friend_router
from api.modules.friend_request.router import router as friend_request_router
from api.modules.merch.router import router as merch_router
from api.modules.profile.router import router as profile_router
from api.modules.quest.router import router as quest_router
from api.modules.reviews.router import router as review_router
from api.modules.unlock_request.router import router as unlock_request_router
