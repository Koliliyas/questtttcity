...
from src.api.modules.chat.schemas import MessageUpdateRequestSchema
from src.core.chat.dto import MessageSendDTO
from src.core.repositories import BaseSQLAlchemyRepository
from src.db.models import Chat, ChatParticipant, Message, Profile, User
...
class ChatRepository(BaseSQLAlchemyRepository[Chat]):
    ...
    async def is_user_participant(self, chat_id: int, user_id: UUID) -> bool:
        """
