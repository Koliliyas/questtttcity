#!/usr/bin/env python3
"""
Финальный скрипт для создания пользователей QuestCity через API регистрации
"""
...
def main():
    ...
    # Создаем администратора (пароль с заглавной буквой)
    print("\n👑 Создание администратора...")
    admin_created = create_user_via_api(
        email="admin@questcity.com",
        password="Admin123",  # Заглавная буква
        username="admin",
        first_name="Admin",
        last_name="User",
        role="admin"
    ...
    # Создаем тестового пользователя (пароль с заглавной буквой)
    print("\n👤 Создание тестового пользователя...")
    user_created = create_user_via_api(
        email="testuser@questcity.com",
        password="Password123",  # Заглавная буква
        username="testuser",
        first_name="Test",
        last_name="User",
        role="user"
