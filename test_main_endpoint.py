#!/usr/bin/env python3
"""
Тест основного endpoint создания квеста
"""
import requests
import json
from datetime import datetime

def test_main_endpoint(base_url="http://questcity.ru/api/v1/"):
    """Тест основного endpoint создания квеста"""
    print(f"🎯 Тест основного endpoint создания квеста")
    print("=" * 60)
    ...
    try:
        ...
        quest_data = {
            "name": "Тестовый квест через основной endpoint",
            "description": "Описание тестового квеста через основной endpoint",
...
def main():
    print("🧪 Тест основного endpoint создания квеста")
    print("=" * 60)
