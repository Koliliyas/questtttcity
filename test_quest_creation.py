#!/usr/bin/env python3
"""
Тестовый скрипт для проверки создания квеста через QuestCity API
"""
import requests
import json
...
def test_quest_creation(base_url="http://questcity.ru/api/v1/"):
    """Тест создания квеста через API"""
    ...
    try:
        ...
        # Тестовые данные для создания квеста
        quest_data = {
            "name": "Тестовый квест",
                    ...
                    "places": [
                        {
                            "longitude": 37.6173,
                            "latitude": 55.7558,
                            "detections_radius": 50,
                            "height": 0,
                            "interaction_inaccuracy": 5,
                            "part": 1,
                            "random_occurrence": False
                        }
                    ],
                    "tool_id": None,
                    "file": None,
...
def main():
    print("🧪 Тестирование создания квеста QuestCity")
    print("=" * 60)
