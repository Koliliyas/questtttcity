#!/usr/bin/env python3
"""
Восстановление недостающих таблиц
"""
import psycopg2
import bcrypt
...
def restore_missing_tables():
    """Восстанавливает недостающие таблицы"""
    print("🔧 ВОССТАНОВЛЕНИЕ НЕДОСТАЮЩИХ ТАБЛИЦ")
    print("=" * 80)
