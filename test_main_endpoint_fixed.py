#!/usr/bin/env python3
"""
Тест основного endpoint с исправленными данными
"""
import requests
import json
from datetime import datetime

def test_main_endpoint_fixed(base_url="http://questcity.ru/api/v1/"):
    """Тест основного endpoint с исправленными данными"""
    print(f"🎯 Тест основного endpoint с исправленными данными")
    print("=" * 60)
    ...
    try:
        ...
        # Исправленные данные для создания квеста
        quest_data = {
            "name": "Тест квест",  # Исправлено: короткое название
        ...
        # Тестируем основной endpoint /quests/
        print(f"\n🔗 Тестирование основного endpoint: quests/")
...
def main():
    print("🧪 Тест основного endpoint с исправленными данными")
    print("=" * 60)
    
    success = test_main_endpoint_fixed()
    ...
    if success:
        ...
        print(f"\n{'='*60}")
        print("❌ Основной endpoint не работает")
